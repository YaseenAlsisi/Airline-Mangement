...
async function run() {
    try {
        ...
        let agentNameForDB = agentRes.rows[0].name;
        ...
        const header = data[0] || [];
        // Hardcode specific indices for Rahlesta to avoid matching bugs!
        let idxDUsd = 13, idxCUsd = 14, idxDEgp = 15, idxCEgp = 16;
        ...
        console.log(`Success! Fixed and inserted ${totalPassengers} passengers and ${totalPayments} payments for Rahlesta.`);
    } catch(e) {
