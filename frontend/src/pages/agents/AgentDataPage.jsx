...
import AgentFormModal from './AgentFormModal';import { jsxDEV as _jsxDEV } from "react/jsx-dev-runtime";
    ...
    _jsxDEV("div", { children: [/*#__PURE__*/
      _jsxDEV("div", { className: "sm:flex sm:items-center", children: [/*#__PURE__*/
        _jsxDEV("div", { className: "sm:flex-auto", children: [/*#__PURE__*/
          _jsxDEV("h1", { className: "text-2xl font-bold leading-6 text-gray-900", children: "Agents" }, void 0, false), /*#__PURE__*/
          _jsxDEV("p", { className: "mt-2 text-sm text-gray-700", children: "A list of all travel agents in the system including their code, name, and status." }, void 0, false
              ...
              _jsxDEV("table", { className: "min-w-full divide-y divide-gray-300", children: [/*#__PURE__*/
                _jsxDEV("thead", { className: "bg-gray-50", children: /*#__PURE__*/
                  _jsxDEV("tr", { children: [/*#__PURE__*/
                    ...
                    _jsxDEV("th", { scope: "col", className: "px-3 py-3.5 text-left text-sm font-semibold text-gray-900", children: "Email" }, void 0, false
                ...
                _jsxDEV("tbody", { className: "divide-y divide-gray-200 bg-white", children:
                  loading ? /*#__PURE__*/
                  _jsxDEV("tr", { children: /*#__PURE__*/
                    _jsxDEV("td", { colSpan: 5, className: "py-4 text-center text-sm text-gray-500", children: "Loading..." }, void 0, false) }, void 0, false
                  ) :
                  agents.length === 0 ? /*#__PURE__*/
                  _jsxDEV("tr", { children: /*#__PURE__*/
                    _jsxDEV("td", { colSpan: 5, className: "py-4 text-center text-sm text-gray-500", children: "No agents found." }, void 0, false) }, void 0, false
                  ) :
                  ...
                  _jsxDEV("tr", { children: [/*#__PURE__*/
                    _jsxDEV("td", { className: "whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6", children:
                      agent.code }, void 0, false
                    ), /*#__PURE__*/
                    _jsxDEV("td", { className: "whitespace-nowrap px-3 py-4 text-sm text-gray-500", children: agent.name }, void 0, false), /*#__PURE__*/
                    _jsxDEV("td", { className: "whitespace-nowrap px-3 py-4 text-sm text-gray-500", children: agent.email || '-' }, void 0, false), /*#__PURE__*/
                    _jsxDEV("td", { className: "whitespace-nowrap px-3 py-4 text-sm text-gray-500", children: /*#__PURE__*/
                      _jsxDEV("span", { className: `inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${
                        ...
                        'bg-yellow-50 text-yellow-800 ring-yellow-600/20'}`, children:

                        agent.status }, void 0, false
                      ) }, void 0, false
                    ), /*#__PURE__*/
                    _jsxDEV("td", { className: "relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6", children:
                      canEdit && /*#__PURE__*/
                      _jsxDEV("button", { onClick: () => handleEdit(agent), className: "text-indigo-600 hover:text-indigo-900", children: ["Edit", /*#__PURE__*/
                        _jsxDEV("span", { className: "sr-only", children: [", ", agent.name] }, void 0, true)] }, void 0, true
                      ) }, void 0, false
