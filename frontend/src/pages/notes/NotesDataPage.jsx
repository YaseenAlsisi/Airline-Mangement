              ...
              <div className="min-w-0 flex-1">
                ...
                >
                  <div className="overflow-hidden rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                    <label htmlFor={`reply-${note.id}`} className="sr-only">Add your reply</label>
                    <textarea
                      rows={2}
                      name="reply"
                      id={`reply-${note.id}`}
    ...
    <div>
      <div className="sm:flex sm:items-center mb-8">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-bold leading-6 text-slate-900">System Notes</h1>
          <p className="mt-2 text-sm text-slate-600">
            Internal log of notes across the system. Can be general or tied to specific records.
          </p>
        </div>
        ...
        <ul role="list" className="divide-y divide-slate-200">
          {loading ? (
            ...
            <li className="px-4 py-12 text-center">
              ...
              <h3 className="mt-2 text-sm font-semibold text-slate-900">No notes found</h3>
              <p className="mt-1 text-sm text-slate-500">Get started by adding a new note.</p>
            </li>
          ) : (
