...
export const MainLayout = () => {
  return (/*#__PURE__*/
    _jsxDEV("div", { children: [/*#__PURE__*/
      _jsxDEV("div", { className: "hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col", children: /*#__PURE__*/
        _jsxDEV(Sidebar, {}, void 0, false) }, void 0, false
      ), /*#__PURE__*/
      _jsxDEV("div", { className: "lg:pl-72 flex flex-col min-h-screen", children: [/*#__PURE__*/
